...
import { fetchPayloadCollection, mapPayloadActivity } from "@/lib/cms-client";
...
export default function ActivitiesPage() {
  ...
  useEffect(() => {
    const loadActivities = async () => {
      const docs = await fetchPayloadCollection("activities", "sort=-date&depth=1");
      setActivities(docs.map(mapPayloadActivity));
    };
